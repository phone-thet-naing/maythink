...
export const WarpBackground: React.FC<WarpBackgroundProps> = ({
  ...
  return (
    <div className={cn(" rounded border p-20", className)} {...props}>
      <div
        style={
          {
        ...
        className={
          "bg-slate-950 pointer-events-none absolute left-0 top-0 size-full overflow-hidden [clip-path:inset(0)] [container-type:size] [perspective:var(--perspective)] [transform-style:preserve-3d]"
        }
      >
        {/* top side */}
